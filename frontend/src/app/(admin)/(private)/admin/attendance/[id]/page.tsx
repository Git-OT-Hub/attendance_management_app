...
import styles from "@/app/(admin)/(private)/admin/attendance/[id]/AttendanceShowPage.module.scss";
import AttendanceShowClient from "@/components/admin/attendanceShow/attendanceShowClient/AttendanceShowClient";

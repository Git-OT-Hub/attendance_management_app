import styles from "@/components/stampCorrectionRequestList/approvedList/ApprovedList.module.scss";
...
const ApprovedList = () => {
    ...
    useEffect(() => {
        apiClient.get('/api/attendance/correction_request_list/approved')
                        ...
                        <tr key={idx}>
                            ...
                            <td>
                                <Link
                                    ...
                                    href={`/attendance/correction/${record.id}`}
                                >詳細</Link>
                            </td>
                        </tr>
                    ))}

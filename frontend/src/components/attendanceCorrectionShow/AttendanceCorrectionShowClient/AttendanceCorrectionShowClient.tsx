"use client";
import styles from "@/components/attendanceCorrectionShow/AttendanceCorrectionShowClient/AttendanceCorrectionShowClient.module.scss";
...
const AttendanceCorrectionShowClient = ({id}: AttendanceCorrectionShowClientProps) => {
    ...
    useLayoutEffect(() => {
        apiClient.get(`/api/attendance/correction/${id}`)
            ...
            .catch((e) => {
                if (e.status === HTTP_FORBIDDEN) {
                    ...
                    router.push('/stamp_correction_request/list');
